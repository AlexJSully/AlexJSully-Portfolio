...
## Bundled subagents, and when to dispatch one
...
| [`surface-auditor`](agents/surface-auditor.md)     | the change touches a public surface, or one fact recurs across comments         | the change is documentation-only   |
