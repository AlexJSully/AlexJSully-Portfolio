...
export default function Privacy() {
	return (
		<div>
			...
			<p>
				Your privacy is important to us. It is my (Alexander Sullivan) portfolio&#39;s policy to respect your
				privacy and comply with any applicable law and regulation regarding any personal information we may
				collect about you, including across our website,{" "}
				<a href="https://alexjsully.me/">https://alexjsully.me/</a>, and other sites we own and operate.{" "}
			</p>
			<p>This policy is effective as of 16 September 2021 and was last updated on 16 September 2021. </p>
			...
			<p>
				You are responsible for selecting any password and its overall security strength, ensuring the security
				of your own information within the bounds of our services.{" "}
			</p>
			...
			<p>
				...
				process, or transfer your personal information may not have the same data protection laws as the country
				in which you initially provided the information. If we transfer your personal information to third
				parties in other countries: (i) we will perform those transfers in accordance with the requirements of
				applicable law; and (ii) we will protect the transferred personal information in accordance with this
				privacy policy.{" "}
			</p>
			...
			<p>
				...
				understand that we will collect, hold, use and disclose it in accordance with this privacy policy. You
			...
			<p>
				...
				irrelevant, or misleading, please contact us using the details provided in this privacy policy. We will
				take reasonable steps to correct any information found to be inaccurate, incomplete, misleading, or out
				of date.{" "}
			</p>
			<p>
				...
				a regulatory body or data protection authority in relation to your complaint.{" "}
			</p>
			<h3>Use of Cookies</h3>
			<p>
				We use &ldquo;cookies&rdquo; to collect information about you and your activity across our site. A
				cookie is a small piece of data that our website stores on your computer, and accesses each time you
				visit, so we can understand how you use our site. This helps us serve you content based on preferences
				you have specified.{" "}
			</p>
			...
			<p>
				...
				current acceptable practices, or legislative or regulatory changes. If we decide to change this privacy
			...
			<p>
				Alexander Sullivan
				<br />
				<a href="mailto:alexjsully.connect@outlook.com" target="_blank" rel="noopener noreferrer">
					alexjsully.connect@outlook.com
				</a>{" "}
				|{" "}
				<a href="https://twitter.com/AlexJSully" target="_blank" rel="noopener noreferrer">
					@AlexJSully
				</a>{" "}
			</p>
		</div>
