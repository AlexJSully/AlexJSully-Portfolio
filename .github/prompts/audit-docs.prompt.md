...
- Every document read this run is no longer, as a whole, than a careful human would have written for the same brief (Rule 6); a page mixing overview and deep depth was split rather than left layered.
